                ...
                <form action="/agenteDados" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="codigo_agente" name="codigo_agente"
                            placeholder="Código Agente" value="{{ $agente ? $agente->codigo_agente : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="sexo" id="sexo">
                                ...
                                @foreach ($sexos as $sexo)
                                    <option value="{{ $sexo->sexo }}" {{ $agente->sexo === $sexo->sexo ? 'selected' : '' }}>
                                        {{ $sexo->sexo }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-control" name="genero" id="genero">
                                ...
                                @foreach ($generos as $genero)
                                    <option value="{{ $genero->genero }}"
                                        {{ $agente->genero === $genero->genero ? 'selected' : '' }}>
                                        {{ $genero->genero }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <input type="submit" class="btn btn-primary"
                        onclick="return confirm('Confirme se deseja Atualizar os dados!')" value="Atualizar Dados Agente">
                </form>
        </div>
    @endsection
