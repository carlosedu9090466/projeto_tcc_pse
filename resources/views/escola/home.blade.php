...
<div class="col-md-10 offset-md-1 mt-5 dashboard-doencas-container">
    @if (count($escolas) > 0)
    ...
    <form action="/escola/home/" method="GET" class="form-inline my-2 my-lg-0 float-md-right">
        <input class="form-control mr-sm-2" id="search" type="text" name="search" placeholder="Pesquisar Escolar" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Pesquise</button>
    </form>

    <table class="table">
        <thead>
            <!-- <td colspan="7" class="bg-pesquisa">
                <form action="/escola/home/" method="GET" class="form-inline float-right">
                    <input class="form-control mr-sm-2" id="search" type="text" name="search" placeholder="Pesquisar Escolar" aria-label="Search">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="nome" placeholder="Nome da Escola" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 ml-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inep" name="inep" placeholder="Digite o inep" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4 ml-md-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bairro" name="bairro" placeholder="Digite o bairro da escola" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 ml-md-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="numero" name="numero" placeholder="Digite o número da escola">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mr-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cep" name="cep" placeholder="Digite o cep do endereço">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 ml-auto">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="telefone" name="telefone" placeholder="Digite o telefone da escola">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="localidade_id" name="localidade_id" required>
